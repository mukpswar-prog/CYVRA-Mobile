...
| **G7** | Mobile section on existing admin/accounts | **This-repo slice.** `mobile_serials` + `/admin/serials` + `ADMIN_API_TOKEN`. Erase button still later. CORS already allowlists admin hosts. |
